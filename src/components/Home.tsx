...
export function Home() {
  ...
  return (
    <div className='max-w-[1344px] mx-auto flex-col flex items-center my-2 md:mt-10'>
      <img src={logoImg} className="md:scale-100 scale-75"/>
      <h1 className='text-xl mt-5 sm:text-4xl md:text-6xl md:mt-10 text-white font-black '>
